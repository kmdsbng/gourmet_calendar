# -*- encoding: utf-8 -*-
class DigistyleEventSourceCrawler
  DIGISTYLE_CATEGORY_INDEX_URL = 'http://www.digistyle-kyoto.com/event/cat524.html'
  # EventSourceの元になるクラス
  class Importee
  ...
  class EventSourceDetector
    ...
    def detect_event_importees(content=nil)
      content ||= load_digistyle_category_index_content
    ...
    def load_digistyle_category_index_content
